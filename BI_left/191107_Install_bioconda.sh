...
# create "scrna" env
conda create -n scrna bioconductor-rhdf5 r-sleuth bioconductor-recount star hisat2 rsem rseqc multiqc qualimap htseq r-seurat trim-galore samtools salmon kallisto igv bioconductor-deseq2
